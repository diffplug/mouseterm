...
- **Must journal desktop alert decisions and local speech attempts without changing delivery behavior.** Logging failure never blocks an alert; diagnostics never hydrate alert state. Pocket and the website demo have no journal port (rationale).
