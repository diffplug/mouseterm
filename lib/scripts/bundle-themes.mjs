...
/** Theme IDs to exclude (e.g. legacy/classic variants, or HC variants —
 *  our chrome is bg-only so HC themes render flat; see design.tsx). */
const EXCLUDED_THEMES = new Set([
  'GitHub.github-vscode-theme.github-light',
  'GitHub.github-vscode-theme.github-dark',
  'GitHub.github-vscode-theme.github-light-high-contrast',
  'GitHub.github-vscode-theme.github-dark-high-contrast',
]);
...
const CONSUMED_KEYS = new Set([
  'foreground',
  'editor.background', 'sideBar.background',
