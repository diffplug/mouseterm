    ...
    <div className="p-8 bg-surface text-foreground min-h-screen">
      ...
      <div className="flex gap-3">
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-micro text-muted">accent</span>
        </div>
        <div className="flex flex-col items-center gap-1">
          <div className="w-12 h-12 rounded bg-surface-alt" />
          <span className="text-micro text-muted">surface-alt</span>
        </div>
        <div className="flex flex-col items-center gap-1">
          <div className="w-12 h-12 rounded bg-surface-raised" />
          <span className="text-micro text-muted">surface-raised</span>
        </div>
        <div className="flex flex-col items-center gap-1">
          <div className="w-12 h-12 rounded bg-error" />
          <span className="text-micro text-muted">error</span>
        </div>
        <div className="flex flex-col items-center gap-1">
          <div className="w-12 h-12 rounded bg-tab-active-bg border border-border" />
          <span className="text-micro text-muted">tab-active</span>
        </div>
        <div className="flex flex-col items-center gap-1">
          <div className="w-12 h-12 rounded bg-terminal-bg border border-border" />
          <span className="text-micro text-muted">terminal-bg</span>
        </div>
      </div>
    </div>
  );
